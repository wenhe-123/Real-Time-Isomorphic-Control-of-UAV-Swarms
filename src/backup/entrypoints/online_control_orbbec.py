...
with the same depth-fused Orbbec path used by ``backup/pipelines/orbbec_main.py``.
...
from functions.open_close.morph_world import ScaleConfig, normalize_morph_points
from online_control import closest_pair, make_initial_live_target
from backup.pipelines import orbbec_main as om
